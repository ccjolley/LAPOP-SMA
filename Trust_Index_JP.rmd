...
```
What are we seeing now? At first sight, the higher values are all now on the higher (25%) quantile, compared to the lower (25%) quantile. There are much larger values for:
* `b21`
* `b21a`
* `b47a`
* `b19`
