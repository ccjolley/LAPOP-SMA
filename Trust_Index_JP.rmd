...
```
What are we seeing now? At first sight, the higher values are all now on the higher (25%) quantile, compared to the lower (25%) quantile. However, there is not a great difference separating the values on either quantile. A note apart should be made for `b21a`(Trust in Executive), where, compared to the lower quantile, the value in the higher quantile is much larger.
