...
At the top of the document, please explain:
- What you are trying to measure with this index
- Which variables you are including and the range of values for each (i.e. "1=yes, 2=no" or "1=a lot, 5=not at all")
- If you've explicitly chosen not to include some relevant-looking variables, what they are and why.

You didn't originally have the `set.seed(12345)` command in there -- I didn't include it in the wealth index either, but it's a good idea. This specifies the starting point for the random number generator used in multiple imputation and ensures that the results of your analysis will be identical every time.
