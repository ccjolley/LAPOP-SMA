...
Our different imputed datasets correlate strongly, and the distribution skews toward high values of PC1.
...
ggplot(data=qchange) +
  ...
  geom_text(aes(x=1,y=qchange$low,label=qchange$label,
