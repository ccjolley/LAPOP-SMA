...
Also note that the values of `vic40`-`vic45` are different in Guatemala than they are in Honduras; we'll need to account for that when creating a regional index.
