...
Also note that the values of `vic40`-`vic45` are different in Honduras than they are in Guatemala; we'll need to account for that when creating a regional index.
...
So it looks like high values of the index indicate not being particularly concerned about crime and violence; we'll need to flip the direction of the index.
