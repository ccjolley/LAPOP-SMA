...
So `vic45` (changing jobs out of fear of crime) and `a4` (what is the biggest problem?) donâ€™t have a really strong influence here. The ones that really dominate here are the diso indicators, asking people what they feel is a problem in their neighborhood.
...
```{r}
#fear6f index â€? correlation is about the same as it was with the original fear index.
